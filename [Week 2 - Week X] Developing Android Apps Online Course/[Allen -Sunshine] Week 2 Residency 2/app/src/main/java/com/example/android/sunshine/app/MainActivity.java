...
public class MainActivity extends ActionBarActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            forecast.add("Wed - Rainy 60/53");
            forecast.add("Thurs - Tornado 30/53");
            forecast.add("Fri - Sunny 30/90");
            forecast.add("Sat - Storm 80/53");

            ArrayAdapter<String> weekforecast = new ArrayAdapter<String>(getActivity
